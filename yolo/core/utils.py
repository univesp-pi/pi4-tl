...
def draw_bbox(image, bboxes, classes=read_class_names(cfg.YOLO.CLASSES), show_label=True):
    ...
    for i, bbox in enumerate(bboxes):
        ...
        if classes[class_ind] == 'car' or classes[class_ind] == 'truck' or classes[class_ind] == 'motorcycle' or classes[class_ind] == 'bus':
            total_cars += 1
    ...
    cv2.putText(image, f'VEICULOS: {total_cars}', (30,150), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 0, 0), 2)
